 ...
 * 
 * @param log_path Path to audit log file (default: /var/log/mirai2026/audit.log)
 * @param researcher_id Researcher identifier
 * @param project_id Project identifier
 * @return 0 on success, -1 on failure
 */
int audit_log_init(const char *log_path, const char *researcher_id, const char *project_id);
