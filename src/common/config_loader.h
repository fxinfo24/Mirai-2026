...
result_t config_get_string(const mirai_config_t *config, const char *path,
                           char **value);
result_t config_get_int(const mirai_config_t *config, const char *path,
                        int64_t *value);
result_t config_get_bool(const mirai_config_t *config, const char *path,
                         bool *value);
